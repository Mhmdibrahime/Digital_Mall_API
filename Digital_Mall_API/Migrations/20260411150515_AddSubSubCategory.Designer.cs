...
namespace Digital_Mall_API.Migrations
{
    ...
    [Migration("20260411150515_AddSubSubCategory")]
    partial class AddSubSubCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Logs.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Orders___Shopping.BrandStatistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Orders___Shopping.RefundTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Orders___Shopping.ShippingGovernorate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Product_Catalog.ProductFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Product_Catalog.SubSubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Reels___Content.ReelReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReportedByCustomerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("ReelReports");
                });

            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Reels___Content.SavedReel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.T_Shirt_Customization.TshirtDesignOrderImage", b =>
                {
                    ...
                    b.ToTable("TshirtDesignOrderImages");
                });
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.T_Shirt_Customization.TshirtDesignSubmissionImage", b =>
                {
                    ...
                    b.ToTable("TshirtDesignSubmissionImages");
                });
            ...
            modelBuilder.Entity("Reel", b =>
                {
                    ...
                    b.Property<string>("PostedByBrandId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("PostedByModelId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("VimeoEmbedHtml")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("VimeoPlayerUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("VimeoUploadUrl")
                        .HasMaxLength(5000)
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("PostedByBrandId");

                    b.HasIndex("PostedByModelId");
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Orders___Shopping.RefundRequest", b =>
                {
                    ...
                    b.HasOne("Digital_Mall_API.Models.Entities.Orders___Shopping.OrderItem", "OrderItem")
                        ...
                        .HasForeignKey("Digital_Mall_API.Models.Entities.Orders___Shopping.RefundRequest", "OrderItemId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Orders___Shopping.RefundTransaction", b =>
                {
                    ...
                    b.HasOne("Digital_Mall_API.Models.Entities.Orders___Shopping.RefundRequest", "RefundRequest")
                        .WithMany()
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Product_Catalog.Product", b =>
                {
                    ...
                    b.HasOne("Digital_Mall_API.Models.Entities.Product_Catalog.SubSubCategory", "SubSubCategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Product_Catalog.ProductFeedback", b =>
                {
                    ...
                    b.HasOne("Digital_Mall_API.Models.Entities.User___Authentication.Customer", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Digital_Mall_API.Models.Entities.Reels___Content.ReelReport", b =>
                {
                    ...
                    b.HasOne("Digital_Mall_API.Models.Entities.User___Authentication.Customer", "ReportedByCustomer")
                        .WithMany()
            ...
            modelBuilder.Entity("Reel", b =>
                {
                    b.HasOne("Digital_Mall_API.Models.Entities.User___Authentication.Brand", "PostedByBrand")
                        .WithMany("Reels")
                        .HasForeignKey("PostedByBrandId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Digital_Mall_API.Models.Entities.User___Authentication.FashionModel", "PostedByModel")
                        .WithMany("Reels")
                        .HasForeignKey("PostedByModelId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("PostedByBrand");

                    b.Navigation("PostedByModel");
                });
